...
class mpsk_stage2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._time_offset_win = qtgui.RangeWidget(self._time_offset_range, self.set_time_offset, "Channel: Timing Offset", "slider", float, QtCore.Qt.Horizontal)
        ...
        self._noise_volt_win = qtgui.RangeWidget(self._noise_volt_range, self.set_noise_volt, "Channel: Noise Voltage", "slider", float, QtCore.Qt.Horizontal)
        ...
        self._freq_offset_win = qtgui.RangeWidget(self._freq_offset_range, self.set_freq_offset, "Channel: Frequency Offset", "slider", float, QtCore.Qt.Horizontal)
