...
class qpsk_stage4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_stage4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_stage4")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_stage4")
        ...
        self.connect((self.digital_linear_equalizer_0, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=qpsk_stage4, options=None):
