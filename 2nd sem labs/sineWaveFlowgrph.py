...
class sineWaveFlowgrph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "My 1st flowgraph", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("My 1st flowgraph")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sineWaveFlowgrph")
        ...
        self._frequency_range = qtgui.Range(0, 100, 1, 50, 200)
...
def main(top_block_cls=sineWaveFlowgrph, options=None):
